...
class MobileCalculatorIndex extends Component {
  state = { 
    answer: "", 
    firstNum: "", 
    secondNum: "",
              ...
              <Segment inverted>
                ...
                <Grid>
                  <Grid.Row> {/*This row will have 7, 8, 9, and divide*/}
                    <Grid.Column width={4}>
                      { calcInt ?
                          <Button size="medium" onClick={() => this.calculateNum2(7)}>7</Button>
                        :
                          <Button size="medium" onClick={() => this.calculateNum1(7)}>7</Button>
                      }
                    </Grid.Column>
                    <Grid.Column width={4}>
                      { calcInt ?
                          <Button size="medium" onClick={() => this.calculateNum2(8)}>8</Button>
                        :
                          <Button size="medium" onClick={() => this.calculateNum1(8)}>8</Button>
                      }
                    </Grid.Column>
                    <Grid.Column width={4}>
                      { calcInt ?
                          <Button size="medium" onClick={() => this.calculateNum2(9)}>9</Button>
                        :
                          <Button size="medium" onClick={() => this.calculateNum1(9)}>9</Button>
                      }
                    </Grid.Column>
                    <Grid.Column width={4}>
                      <Button size="medium" color="blue" onClick={() => this.calculateInt("divide")}>
                  ...
                  <Grid.Row> {/*This row will have 4, 5, 6, and multiply*/}
                    <Grid.Column width={4}>
                      { calcInt ?
                          <Button size="medium" onClick={() => this.calculateNum2(4)}>4</Button>
                        :
                          <Button size="medium" onClick={() => this.calculateNum1(4)}>4</Button>
                      }
                    </Grid.Column>
                    <Grid.Column width={4}>
                      { calcInt ?
                          <Button size="medium" onClick={() => this.calculateNum2(5)}>5</Button>
                        :
                          <Button size="medium" onClick={() => this.calculateNum1(5)}>5</Button>
                      }
                    </Grid.Column>
                    <Grid.Column width={4}>
                      { calcInt ?
                          <Button size="medium" onClick={() => this.calculateNum2(6)}>6</Button>
                        :
                          <Button size="medium" onClick={() => this.calculateNum1(6)}>6</Button>
                      }
                    </Grid.Column>
                    <Grid.Column width={4}>
                      <Button size="medium" color="blue" onClick={() => this.calculateInt("multiply")}>
                  ...
                  <Grid.Row> {/*This row will have 1, 2, 3, and subtract*/}
                    <Grid.Column width={4}>
                      { calcInt ?
                          <Button size="medium" onClick={() => this.calculateNum2(1)}>1</Button>
                        :
                          <Button size="medium" onClick={() => this.calculateNum1(1)}>1</Button>
                      }
                    </Grid.Column>
                    <Grid.Column width={4}>
                      { calcInt ?
                          <Button size="medium" onClick={() => this.calculateNum2(2)}>2</Button>
                        :
                          <Button size="medium" onClick={() => this.calculateNum1(2)}>2</Button>
                      }
                    </Grid.Column>
                    <Grid.Column width={4}>
                      { calcInt ?
                          <Button size="medium" onClick={() => this.calculateNum2(3)}>3</Button>
                        :
                          <Button size="medium" onClick={() => this.calculateNum1(3)}>3</Button>
                      }
                    </Grid.Column>
                    <Grid.Column width={4}>
                      <Button size="medium" color="blue" onClick={() => this.calculateInt("subtract")}>
                  ...
                  <Grid.Row> {/*This row will have clear, 0, and add*/}
                    ...
                    <Grid.Column width={4}>
                      { calcInt ?
                          <Button size="medium" onClick={() => this.calculateNum2(0)}>0</Button>
                        :
                          <Button size="medium" onClick={() => this.calculateNum1(0)}>0</Button>
                      }
                    </Grid.Column>
                    <Grid.Column width={4}></Grid.Column>
                    <Grid.Column width={4}>
                      <Button size="medium" color="blue" onClick={() => this.calculateInt("add")}>
...
export default MobileCalculatorIndex;